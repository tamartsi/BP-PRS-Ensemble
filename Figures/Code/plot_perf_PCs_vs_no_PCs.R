...
SBP_file <- read.csv("/2022_BP_ensemble/Results/TOPMed_Cross_Validation_baseline_results_PCs_vs_no_PCs_SBP.csv")
...
DBP_file <- read.csv("/2022_BP_ensemble/Results/TOPMed_Cross_Validation_baseline_results_PCs_vs_no_PCs_DBP.csv")
...
#ggsave(filename  = "/2022_BP_ensemble/Figures/TOPMed_model_perf_PCs_vs_no_PCs.png", width = 8, height = 5, device='png', dpi=600)
