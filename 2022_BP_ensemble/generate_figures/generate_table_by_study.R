...
trial2 <- pheno_file %>% select(Study)
...
table2 %>%
  as_flex_table() %>%
  #flextable::save_as_docx(path = "~/Dropbox (Partners HealthCare)/2022_BP_ensemble/Figures/by_study_portrait.docx", pr_section = sect_properties)
  flextable::save_as_image(path = "~/Dropbox (Partners HealthCare)/2022_BP_ensemble/Figures/by_study_portrait.png", webshot = "webshot")
