...
pheno_file <- read.csv(file = "~/Dropbox (Partners HealthCare)/2022_BP_ensemble/Data/csv_for_figures/full_data_20230126.csv")
...
trial2 <- pheno_file %>% select(Gender,"Race/Ethnicity")
...
table2 %>%
  as_flex_table() %>%
  #flextable::save_as_docx(path = "~/Dropbox (Partners HealthCare)/2022_BP_ensemble/Figures/Gender_by_Race_Ethnicity_portrait.docx", pr_section = sect_properties)
  flextable::save_as_image(path = "~/Dropbox (Partners HealthCare)/2022_BP_ensemble/Figures/Gender_by_Race_Ethnicity_portrait.png", webshot = "webshot")
