...
results <- read.csv(file = "/Users/mr447/Documents/yana_hrytsenko_bwh_projects/2022_BP_ensemble/copy_results_BP_ensembl_TopMed/baseline_results_20230302.csv", stringsAsFactors = TRUE)
...
h <- ggplot(data = results, aes(group, test_result, group = model_type, fill=model_type)) +
  ...
  scale_y_continuous(breaks = seq(0,35.0, by = 5.0)) +
  scale_fill_viridis_d(option = "viridis") +
  facet_wrap(~ phenotype)
h

ggsave(filename  = "/Users/mr447/Documents/yana_hrytsenko_bwh_projects/2022_BP_ensemble/figures/Baseline_model_perf_TOPMed_full_PRS.tiff", width = 15, height = 10, device='tiff', dpi=300)
