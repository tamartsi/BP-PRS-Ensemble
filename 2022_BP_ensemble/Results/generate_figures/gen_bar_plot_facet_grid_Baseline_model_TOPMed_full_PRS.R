...
results <- read.csv(file = "/Users/mr447/Documents/yana_hrytsenko_bwh_projects/2022_BP_ensemble/Results/TOPMed_baseline_results_20230316.csv", stringsAsFactors = TRUE)
...
numerical_value_string <- substr(percent_value_string, 1,5)
...
ggsave(filename  = "/Users/mr447/Documents/yana_hrytsenko_bwh_projects/2022_BP_ensemble/figures/TOPMed_Baseline_model_perf_full_PRS.png", width = 12, height = 7, device='png', dpi=300)
