...
ggsave(filename  = "/Users/mr447/Documents/yana_hrytsenko_bwh_projects/2022_BP_ensemble/figures/MGBB_no_meds_XGB_Ensemble_model_perf_full_PRS.png", width = 12, height = 7, device='png', dpi=300)
