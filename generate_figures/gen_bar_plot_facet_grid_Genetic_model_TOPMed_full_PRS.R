...
ggsave(filename  = "/Users/yana/Documents/GitHub/BWH_projects/2022_BP_ensemble/figures_final/larger_fonts/TOPMed_Genetic_model_perf_full_PRS.png", width = 10, height = 5, device='png', dpi=600)
