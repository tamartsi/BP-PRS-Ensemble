...
MGBB_results_dbp <- read.csv(file = "/Users/yana/Library/CloudStorage/OneDrive-BethIsraelLaheyHealth/2022_BP_ensemble/Results/20230705/MGBB_results/With\ Meds/meds_dbp_mgbb_full_prs_results\ 20230705.csv", stringsAsFactors = TRUE)

MGBB_results_sbp <- read.csv(file = "/Users/yana/Library/CloudStorage/OneDrive-BethIsraelLaheyHealth/2022_BP_ensemble/Results/20230705/MGBB_results/With\ Meds/meds_sbp_mgbb_full_prs_results\ 20230705.csv", stringsAsFactors = TRUE)
...
h <- ggplot(data = XGB_data, aes(group, test_result, group = Model.Complexity, fill=Model.Complexity)) +
  ...
  ylim(-2.0,10.0) +
  scale_fill_manual(values = wes_palette("BottleRocket2")[c(1,3,2)])  + 
...
ggsave(filename  = "/Users/yana/Documents/GitHub/BWH_projects/2022_BP_ensemble/figures_final/larger_fonts/MGBB_combined_Ensemble_and_Genetic_plots_model_perf_PVE_strip_title_WITH_MEDS.png", plot = k, width = 10, height = 5, device='png', dpi=600)
